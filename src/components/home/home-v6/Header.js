...
const Header = () => {
  ...
  useEffect(() => {
    ...
    // set initial state in case user loads mid‑page
    onScroll();
      ...
      >
        <nav className="posr" aria-label="Main">
          <div className="container posr menu_bdrt1">
            {/* Three columns: left logo, middle menu (stretches), right actions */}
            <div className="row align-items-center">
              ...
              <div className="col-auto">
                <div className="d-flex align-items-center">
                  <div className="logos mr40">
                    ...
                    {/* Secondary logo for sticky/dark mode if you use CSS to toggle */}
              ...
              {/* MIDDLE: Menu (stretches & pushes menu to the right) */}
