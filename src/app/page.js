...
<section className="pb90 pb30-md">
  <div className="container">
    <div className="row g-3 align-items-stretch">
      {/* WHY CHOOSE US — make this slimmer */}
      <div className="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <div className={`about-box2 ${styles.whyWrap} h-90`}>
      ...
      {/* FIND HOME BLOCKS — make this wider */}
      <div className="col-xl-8 col-lg-6" data-aos="fade-up" data-aos-delay="300">
